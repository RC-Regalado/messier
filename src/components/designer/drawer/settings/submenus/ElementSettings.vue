  ...
  <div>
    ...
    <menu-toggle menuHeader="Text" :hidden="hideTextSettings">
      <div class="menu">
        ...
        <v-text-field class="text-item" v-model="att.value" label="Text" dense
                      v-if="(typeof att.value !== 'undefined' && att.value !== null)"
                      @keyup.native="e => onAttrsChanges('value', e.target.value)"/>
        <v-text-field class="text-item" v-model="txt" label="Text" dense v-else
                      @keyup.native="e => emitChanges('text', e.target.value)"/>
      </div>
    </menu-toggle>

    <menu-toggle menuHeader="Placeholder"
                 :hidden="(typeof att.placeholder === 'undefined' || att.placeholder === null)">
      <div class="menu">
        <v-text-field class="text-item" v-model="att.placeholder" label="Placeholder" dense
    ...
    <menu-toggle menuHeader="Image" :hidden="(typeof att.src === 'undefined' || att.src === null)">
      <div class="menu">
        <v-text-field class="text-item" v-model="att.src" label="Image URL" dense
    ...
    <menu-toggle menuHeader="Border">
      <div class="menu">
        <icon-select class="text-item" :value="borderSelected"
                     :icon="assets['border'+borderSelected]" label="Border"
...
export default {
  ...
  data: function () {
    return {
      ...
      borderSelected: '',
      font: assets.font,
      font_size: assets.font_size,
      text_color: assets.text_color,
      border_color: assets.border_color,
      border_weight: assets.border_weight,
      border_style: assets.border_style,
      corner_radius: assets.corner_radius,
