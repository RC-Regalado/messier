...
<div>
  ...
  <menu-toggle menuHeader="Text" :hidden="hideTextSettings">
    <div class="menu">
      ...
      <mcw-textfield class="text-item" v-model="att.value" label="Text" dense
        v-if="(typeof att.value !== 'undefined' && att.value !== null)"
        @keyup.native="e => onAttrsChanges('value', e.target.value)"/>
      <mcw-textfield class="text-item" v-model="txt" label="Text" dense v-else
  ...
  <menu-toggle menuHeader="Placeholder" :hidden="(typeof att.placeholder === 'undefined' || att.placeholder === null)">
    <div class="menu">
      <mcw-textfield class="text-item" v-model="att.placeholder" label="Placeholder" dense
  ...
  <menu-toggle menuHeader="Image" :hidden="(typeof att.src === 'undefined' || att.src === null)">
    <div class="menu">
      <mcw-textfield class="text-item" v-model="att.src" label="Image URL" dense
